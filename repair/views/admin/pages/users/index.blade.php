        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Manajemen Data User</h3>
                    ...
                    <table id="userTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $user->dibuat_pada ? \Carbon\Carbon::parse($user->dibuat_pada)->format('d/m/Y H:i') : '-' }}</td>
                                <td>{{ $user->dibuat_oleh ?? '-' }}</td>
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal{{ $user->id_user }}">
