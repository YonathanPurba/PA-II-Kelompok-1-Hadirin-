                ...
                <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                    <form method="GET" action="{{ route('users.index') }}" class="d-flex align-items-center gap-3 flex-wrap">
                        <div class="d-flex align-items-center gap-2">
                            <label for="role" class="me-2 mb-0">Role:</label>
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <select name="status" id="status" class="form-select">
                                ...
                                <option value="aktif" {{ (request('status') == 'aktif' || (!request()->has('status') && !request()->has('role') && !request()->has('search'))) ? 'selected' : '' }}>Aktif</option>
